...
const s = StyleSheet.create({
  ...
  card: { width: '100%', maxWidth: 320, borderRadius: 16, backgroundColor: '#1C1C1C', padding: 20 },
  ...
  btn: { height: 44, borderRadius: 12, backgroundColor: '#2A2A2A', alignItems: 'center', justifyContent: 'center' },
  btnMain: { backgroundColor: C.brand },
  btnText: { color: C.text, fontSize: 14, lineHeight: 18, fontWeight: '600' },
  btnMainText: { color: C.onBrand },
  input: { backgroundColor: '#2A2A2A', borderRadius: 10, color: C.text, fontSize: 14, paddingHorizontal: 14, height: 44, marginTop: 14 },
