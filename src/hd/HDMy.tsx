...
const st = StyleSheet.create({
  ...
  fnCard: { flex: 1, height: 116, borderRadius: 16, backgroundColor: C.surface, alignItems: 'center', justifyContent: 'center', gap: 7, paddingHorizontal: 8, overflow: 'hidden' },
  ...
  plCard: { gap: 8, paddingBottom: 4, overflow: 'hidden' },
