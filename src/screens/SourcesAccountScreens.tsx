...
const st = StyleSheet.create({
  ...
  rowDivide: { borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: '#FFFFFF0F', marginTop: 8, paddingTop: 8 },
  ...
  addAction: {
    height: 42, borderRadius: 12, borderWidth: 1, borderColor: '#FFFFFF1F',
  ...
  linkBtn: { height: 46, borderRadius: 12, borderWidth: 1, borderColor: '#FFFFFF1F', alignItems: 'center', justifyContent: 'center' },
  ...
  modalMask: { flex: 1, backgroundColor: '#000000AA', alignItems: 'center', justifyContent: 'center', padding: 28 },
  modalCard: { width: '100%', borderRadius: 16, backgroundColor: '#1A1A1A', padding: 18, gap: 12 },
  modalTitle: { color: C.text, fontSize: 16, fontWeight: '700' },
  input: { height: 44, borderRadius: 10, backgroundColor: '#242424', paddingHorizontal: 12, color: C.text, fontSize: 13 },
  modalHint: { color: C.text2, fontSize: 11, lineHeight: 15 },
  modalBtns: { flexDirection: 'row', gap: 10, marginTop: 2 },
  modalBtnGhost: { flex: 1, height: 42, borderRadius: 10, borderWidth: 1, borderColor: '#FFFFFF1F', alignItems: 'center', justifyContent: 'center' },
