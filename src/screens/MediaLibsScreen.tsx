...
const st = StyleSheet.create({
  ...
  // 艺术家/歌单行
  artistRow: { minHeight: 60, flexDirection: 'row', alignItems: 'center', gap: 12, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#FFFFFF0A' },
  plRow: { minHeight: 60, flexDirection: 'row', alignItems: 'center', gap: 12, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#FFFFFF0A' },
  artistArt: { width: 44, height: 44, borderRadius: 22 },
  artistFallback: { borderRadius: 22, backgroundColor: '#1E2B24', alignItems: 'center', justifyContent: 'center' },
