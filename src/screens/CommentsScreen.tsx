...
const st = StyleSheet.create({
  ...
  pill: { height: 28, borderRadius: 14, paddingHorizontal: 14, justifyContent: 'center', backgroundColor: '#242424' },
  ...
  avatarFallback: { backgroundColor: '#2E2E2E', alignItems: 'center', justifyContent: 'center' },
